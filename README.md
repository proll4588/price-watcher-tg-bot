...
Telegram-бот для отслеживания цен на товары с маркетплейсов Wildberries и других.

> **🚀 Быстрый старт:** [QUICK_START.md](QUICK_START.md) | **📚 Документация:** [docs/README.md](docs/README.md)

## 🎯 Возможности

- **Отслеживание цен** на товары с Wildberries
...
- **Комплексная аналитика** с Grafana и Prometheus
- **Мониторинг в реальном времени** пользователей, отслеживаний и воркеров
...
Приложение включает комплексную систему аналитики и мониторинга с использованием Prometheus и Grafana.

### Ключевые метрики

- **Пользователи**: новые пользователи, активные пользователи, общее количество
- **Отслеживания**: запросы на отслеживание, активные отслеживания, удаления
- **Воркеры**: проверки цен, время выполнения, ошибки, уведомления
- **Товары**: отслеживаемые товары, снимки цен, изменения цен
- **Очереди**: ожидающие задачи, активные задачи, завершенные/неудачные задачи
...
1. **Price Watcher - Обзор** - основные метрики системы
2. **Price Watcher - Воркеры и очереди** - мониторинг производительности
3. **Price Watcher - Аналитика по провайдерам** - анализ по торговым площадкам
...
- [x] Комплексная система аналитики с Grafana и Prometheus
- [x] Мониторинг пользователей, отслеживаний и воркеров в реальном времени
